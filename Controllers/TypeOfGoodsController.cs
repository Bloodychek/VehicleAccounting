...
namespace VehicleAccounting.Controllers
{
    public class TypeOfGoodsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,nameOfGoods")] TypeOfGoods typeOfGoods)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,nameOfGoods")] TypeOfGoods typeOfGoods)
        {
